...
//            MongoConnector dbo = new MongoConnector();
            MongoDatabase database = MongoConnector.getInstance();
...
//            MongoConnector dbo = new MongoConnector();
    ...
    public static ArrayList<Document> getAnswerPaneAnswers(int userid) {
...
//            MongoConnector dbo = new MongoConnector();
    ...
    public static String finalSurveyAnalysis(String usrname) {
...
class StartAnswerService {
    public static void main(String[] args) {
        SurveyAnswerService anwSvy = new SurveyAnswerService();
        System.out.println(anwSvy.finalSurveyAnalysis("madusanka.wettewa@gmail.com"));
    }
}
